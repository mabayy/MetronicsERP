...
public interface IStockService
{
    ...
    /// <summary>Stok masuk. Bila <paramref name="unitCost"/> diisi, biaya rata-rata bergerak produk diperbarui.</summary>
    Task<StockResult> StockInAsync(int productId, int warehouseId, int quantity, DateTime date, string? note, string? user, decimal? unitCost = null);
